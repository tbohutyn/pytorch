...
class TestCppExtensionJIT(common.TestCase):
    ...
    def _test_jit_xpu_extension(self, extra_sycl_cflags=[], extra_ldflags=[]):
    ...
    def test_jit_xpu_archlists(self):
        ...
        try:
            for c in cases:
                ...
                extra_sycl_cflags = (
                    c["extra_sycl_cflags"] if "extra_sycl_cflags" in c else []
                )
                extra_ldflags = c["extra_ldflags"] if "extra_ldflags" in c else []
                self._test_jit_xpu_extension(
